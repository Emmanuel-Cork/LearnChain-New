...
import "./LearnChainToken.sol";

contract LearnChainTokenSale {
    address payable admin;
    LearnChainToken public tokenContract;
    uint256 public tokenPrice;
    uint256 public tokensSold;

    event Sell(address _buyer, uint256 _amount);

    constructor(LearnChainToken _tokenContract, uint256 _tokenPrice) public {
        admin = msg.sender;
